...
\begin{frame}[fragile]{Last one did not go well}
    \begin{itemize}
        ...
        \item Interrupted at 274.2706938 because of the test
        \newline (Slide with $b<d$: sim stopped because the population went extinct, I did not stop it!)
        \item At stop time
        \begin{itemize}
            \item $N =$ \ensuremath{2.5131\times 10^{4}}
            \item $|N| =$ 49934 (and $|t|$ as well, of course!)
...
\end{alltt}
\begin{verbatim}
## [1] 1.382969e-03 8.398067e-04 2.214102e-03 2.589683e-04 9.708690e-04
## [6] 3.973298e-09
\end{verbatim}
...
\hldef{params} \hlkwb{<-} \hlkwd{list}\hldef{(}\hlkwc{gamma} \hldef{= gamma,} \hlkwc{beta} \hldef{= beta,}
               \hlkwc{Pop} \hldef{=} \hlnum{1000}\hldef{,} \hlkwc{I_0} \hldef{=} \hlnum{2}\hldef{,}
...
\maxFrameImage{FIGS/course-03-parallel-CTMC-1.pdf}
