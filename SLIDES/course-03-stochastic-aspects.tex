...
\begin{frame}[fragile]{Last one did not go well}
    \begin{itemize}
        ...
        \item Interrupted at 334.5188344 because of the test
        \newline (Slide with $b<d$: sim stopped because the population went extinct, I did not stop it!)
        \item At stop time
        \begin{itemize}
            \item $N =$ \ensuremath{5.4713\times 10^{4}}
            \item $|N| =$ 109180 (and $|t|$ as well, of course!)
...
\end{alltt}
\begin{verbatim}
## [1] 2.595269e-04 2.163820e-04 8.359925e-05 6.583614e-04 1.230141e-04
## [6] 1.317517e-09
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\hlcom{# Beamer frame}
\hlkwd{assign}\hldef{(}\hlsng{"run_one_sim"}\hldef{, run_one_sim,} \hlkwc{envir} \hldef{= .GlobalEnv)}
\end{alltt}
\end{kframe}
\end{knitrout}
