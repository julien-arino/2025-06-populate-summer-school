...
\begin{frame}[fragile]{Last one did not go well}
    \begin{itemize}
        ...
        \item Interrupted at 338.7126862 because of the test
        \newline (Slide with $b<d$: sim stopped because the population went extinct, I did not stop it!)
        \item At stop time
        \begin{itemize}
            \item $N =$ \ensuremath{6.1564\times 10^{4}}
            \item $|N| =$ 122767 (and $|t|$ as well, of course!)
...
\end{alltt}
\begin{verbatim}
## [1] 1.032524e-04 1.501491e-04 1.283565e-03 7.772778e-04 2.509549e-04
## [6] 6.210030e-09
\end{verbatim}
