...
\begin{frame}[fragile]{Last one did not go well}
    \begin{itemize}
        ...
        \item Interrupted at 344.5216414 because of the test
        \newline (Slide with $b<d$: sim stopped because the population went extinct, I did not stop it!)
        \item At stop time
        \begin{itemize}
            \item $N =$ \ensuremath{9.5169\times 10^{4}}
            \item $|N| =$ 188728 (and $|t|$ as well, of course!)
...
\end{alltt}
\begin{verbatim}
## [1] 1.763562e-04 1.582589e-03 1.618129e-04 3.686261e-05 4.897857e-04
## [6] 4.325443e-09
\end{verbatim}
